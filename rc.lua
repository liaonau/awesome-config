...
--{{{ grabn
--local grabn_status = nil
--function grabn()
--    grabn_status = naughty.notify({
--        text = string.format("<span fgcolor='#ff0000'>d - delugestatus\nf - di\nw - weather\n</span>"),
--        title="<span fgcolor='#ff0000'>naughty</span>",
--        timeout=0,
--    })
...
--        if key == 'd' then
--            add_deluge()
--            if (grabn_status ~= nil) then naughty.destroy(grabn_status) end
--            keygrabber.stop()
--        else
--            keygrabber.stop()
--        end
